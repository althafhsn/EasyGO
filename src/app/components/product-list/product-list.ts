...
export class ProductList implements OnInit, OnChanges, OnDestroy {
  ...
  // Search text handed down from App (which got it from the Navbar)
  ...
  ngOnChanges(changes: SimpleChanges) {
    console.log('searchTerm changed:', this.searchTerm);
  }
  ...
  // Plain TypeScript filtering — no service, no RxJS needed
